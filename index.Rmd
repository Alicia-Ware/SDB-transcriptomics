...
knitr::kable(head(top_hits_df_a1, n=10),booktabs=TRUE, caption= "**Outputs of the limma differential gene expression analysis pipeline**")
```


The outputs of the limma analysis pipeline are explained below.

+ _LogFC_: reports the log~2~-fold change between groups as specified by the contrast matrix; here, the specified contrast was SDB - PK, therefore positive values represent genes more highly expressed in the SDB group, and negative values those more highly expressed in the PK group.

+ _AveExpr_ is the average log~2~-CPM for the gene across all samples in the experiment. 

+ _t_ gives the moderated t-statistic, which is the ratio of the logFC to the standard error.

+ The _P.Value_ is the associated p-value, whereas the _adj.P.Val_ is the false discovery rate determined by the Benjamini-Hochberg method. 

+ Finally, _B_ describes the log-odds that the gene is truly differentially expressed. For example: B9J08_001548 returns a B of `r round(top_hits_df_a1$logFC[1],2)`, so the odds that this transcript is differentially expressed between phenotypes is _e_^`r round(top_hits_df_a1$logFC[1],2)`^ or `r format(round(exp(7.814261067),0), scientific=FALSE)` to 1.
...
datatable(my_diff_genes_a1,
          ...
          caption = htmltools::tags$caption(style = 'caption-side: top; text-align: left;',
                                            htmltools::tags$span("Table 6.12:", style="color:black"),
...
Differentially-expressed genes between SDB and PK samples from NCPF8973 were identified using the same pipeline as the combined isolate analysis, as explained above.
...
knitr::kable(head(top_hits_df_a4, n=10),booktabs=TRUE, caption= "**Outputs of the limma differential gene expression analysis pipeline for NCPF8973**")
```
...
datatable(my_diff_genes_a4,
              extensions = c('KeyTable', "FixedHeader"),
              caption = htmltools::tags$caption(style = 'caption-side: top; text-align: left;',
                                                htmltools::tags$span("Table 6.22:", style="color:black"),
...
knitr::kable(head(top_hits_df_a7, n=10),booktabs=TRUE, caption= "**Outputs of the limma differential gene expression analysis pipeline for NCPF8973**")
```
...
datatable(my_diff_genes_a7,
              extensions = c('KeyTable', "FixedHeader"),
              caption = htmltools::tags$caption(style = 'caption-side: top; text-align: left;',
                                                htmltools::tags$span("Table 6.32:", style="color:black"),
...
datatable(GO_res_up_a1,
          extensions = c('KeyTable', "FixedHeader"),
          caption = htmltools::tags$caption(style = 'caption-side: top; text-align: left;',
                                            htmltools::tags$span("Table 7.11:", style="color:black"),
...
int_GO_down <- datatable(GO_res_down_a1_cluster_2, 
                       extensions = c('KeyTable', "FixedHeader"), 
                       caption = htmltools::tags$caption(style = 'caption-side: top; text-align: left;',
                                                htmltools::tags$span("Table 7.2:", style="color:black"),
...
datatable(GO_res_up_a4,
          extensions = c('KeyTable', "FixedHeader"),
          caption = htmltools::tags$caption(style = 'caption-side: top; text-align: left;',
                                            htmltools::tags$span("Table 7.21:", style="color:black"),
...
datatable(GO_res_down_a4_cluster_2, 
                       extensions = c('KeyTable', "FixedHeader"), 
                       caption = htmltools::tags$caption(style = 'caption-side: top; text-align: left;',
                                                htmltools::tags$span("Table 7.22:", style="color:black"),
                                                htmltools::tags$span("Gene Ontology results for downregulated DEGs",
                                                                     style="font-weight:bold; color:black")
                                                ),
                       escape = FALSE, #necessary to achieve the subscript above using html coding
...
datatable(GO_res_up_a7,
          extensions = c('KeyTable', "FixedHeader"),
          caption = htmltools::tags$caption(style = 'caption-side: top; text-align: left;',
                                            htmltools::tags$span("Table 7.31:", style="color:black"),
...
datatable(GO_res_down_a7_cluster_2, 
                       extensions = c('KeyTable', "FixedHeader"), 
                       caption = htmltools::tags$caption(style = 'caption-side: top; text-align: left;',
                                                htmltools::tags$span("Table 7.32:", style="color:black"),
                                                htmltools::tags$span("Gene Ontology results for downregulated DEGs",
                                                                     style="font-weight:bold; color:black")
                                                ),
                       escape = FALSE, #necessary to achieve the subscript above using html coding
